GUIDES = [
  ...
  ["Aura Reading",
    "Azelf allows you to read the aura of people to gain information about their desires.\n\nSimply stand next to the person you want to aura read and press the Field Action button (default: A). This opens a menu where you can select Azelf.\n\nMind that Azelf will not be available in the Field Action menu if there is nothing to read in front of you. It is only possible to read the aura of people or Pokémon with active motivations on their mind."],
  ["Jobs",
